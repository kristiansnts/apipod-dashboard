...
@section('content')
    <div class="w-full max-w-md light-card p-8 lg:p-10 rounded-[32px] animate-fade-in">
        <div class="text-center mb-10">
            ...
            <p class="text-gray-500 font-medium">Join the intelligent AI proxy network</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-5">
            ...
            <div>
                <label for="name" class="block text-gray-700 text-sm font-bold mb-1.5">Full Name</label>
                <input type="text" name="name" id="name" value="{{ old('name') }}" required
                    class="w-full bg-gray-50 border border-gray-100 rounded-2xl py-3 px-5 text-gray-900 leading-tight focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all font-medium"
                    placeholder="John Doe">
            </div>

            <div>
                <label for="email" class="block text-gray-700 text-sm font-bold mb-1.5">Email Address</label>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label for="password" class="block text-gray-700 text-sm font-bold mb-1.5">Password</label>
                ...
                <div>
                    <label for="password_confirmation" class="block text-gray-700 text-sm font-bold mb-1.5">Confirm</label>
            ...
            <p class="text-center text-gray-500 text-sm font-medium pt-2">
