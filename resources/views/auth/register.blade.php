...
<div class="w-full max-w-md bg-white dark:bg-[#161615] p-8 rounded-lg shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
    <h2 class="text-2xl font-bold mb-6 text-center text-[#1b1b18] dark:text-[#EDEDEC]">Register</h2>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mb-4">
            <label for="name" class="block text-[#1b1b18] dark:text-[#EDEDEC] text-sm font-bold mb-2">Name</label>
        ...
        <div class="mb-4">
            <label for="password_confirmation" class="block text-[#1b1b18] dark:text-[#EDEDEC] text-sm font-bold mb-2">Confirm Password</label>
        ...
        <div class="mt-4 text-center">
            <a href="{{ route('login') }}" class="text-sm text-[#F53003] hover:text-[#d92902] hover:underline">Already have an account? Login</a>
        </div>
    </form>
</div>
@endsection
